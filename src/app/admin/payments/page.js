...
const AdminPayments = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white rounded-3xl border border-gray-100 shadow-sm p-12 text-center space-y-6">
      <div className="p-6 bg-purple-50 text-purple-600 rounded-full animate-pulse">
        <CreditCard size={48} />
      </div>
      <div className="space-y-2">
        <h1 className="text-2xl font-bold text-gray-900">Payment Gateway Management</h1>
        <p className="text-gray-500 max-w-md mx-auto">
          We are currently integrating financial analytics and transaction logs into this dashboard.
        </p>
      </div>
